        ...
        switch (propertyType)
        {
            ...
            case SerializedPropertyType.Boolean:
                if (value.GetType() == typeof(bool[]))
                {
                    ...
                    {
                        EditorGUI.Toggle(position, label, b);
                    }

                    //SerializedProperty arraySizeProp = value.FindPropertyRelative("Array.size");
                    ...
                    //{
                    //    EditorGUILayout.PropertyField(value.GetArrayElementAtIndex(i));
                    //}
